        ...
        data: {
            ...
            datasets: [{
                ...
                data: extraerdatos.map((item) => {
                    //Este if le indica a que si item.ingresos o item.ganancias es mayor que cero, mediante return lo muestre en elgráfico. Por el contrario no va a mostrarlo
                    if(item.epsreal > 0){
                        return item.epsreal;
                    }
                }),
